...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <footer className="page-footer"><span><ChefHat /> RECETAS AIR</span><p>Hecho para cocinar rico, fácil y sin aceite.</p><button className="update-button" onClick={forceUpdate}>Actualizar app · v1.6</button><small>Los datos se guardan únicamente en este dispositivo.</small></footer>
