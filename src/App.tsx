...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <footer className="page-footer"><span><ChefHat /> ZUNO</span><button className="update-button" onClick={forceUpdate}>{t('update')} · v1.17</button><small>{t('localData')}</small></footer>
